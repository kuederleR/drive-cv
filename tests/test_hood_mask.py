...
class TestHoodMask(unittest.TestCase):
    ...
    def test_lane_config_defaults(self):
        config = LaneConfig()
        self.assertTrue(config.hood_mask_enabled)
